  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      ...
      <div className="col-span-3 bg-white rounded-xl shadow p-5">
        ...
        <p className="mt-4 text-sm font-medium">Attachments</p>
        <Paperclip className="mt-2 text-gray-500 hover:text-blue-600 cursor-pointer" />
      </div>
      ...
      <div className="col-span-6 bg-white rounded-xl shadow p-5">
        ...
        <div className="space-y-4 text-sm">
          <div className="bg-gray-100 p-3 rounded-lg">
            <b>{ticket.client?.name}:</b> {ticket.subject}
          </div>

          <div className="bg-blue-100 p-3 rounded-lg">
            <b>Agent:</b> Investigating the issue.
          </div>
        </div>

        <input
          className="mt-4 w-full border rounded-lg px-4 py-2 focus:outline-blue-500"
          placeholder="Type your message..."
        />
      </div>
